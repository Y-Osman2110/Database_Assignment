...
public class Select {
    ...
    public static void findMemeberByPhone(String phone) {
        ...
        try(Connection conn = Database.getConnection();
            PreparedStatement statement = conn.prepareStatement(sql)) {
                ...
                else System.out.println("Couldn't find member with phone number: " + phone);
        }
    ...
    //------------------------------//
    public static void findTrainersBySpecialty(String specialty) {
        String sql = "SELECT * FROM Trainer WHERE trainerSpeciality = ?";
        ...
        try(Connection conn = Database.getConnection();
            PreparedStatement statement = conn.prepareStatement(sql)) {
                ...
                if(!found) System.out.println("Couldn't find member with specialty: " + specialty);
        }
        catch(SQLException e) {
            System.out.println(e.getMessage());
        }
    ...
    public static void findMembersWithExpiredSubscriptions() {
        ...
        try(Connection conn = Database.getConnection();
            PreparedStatement statement = conn.prepareStatement(sql)) {
                ...
                if(!found) System.out.println("There's no member with expired subscriptions currently.");
        }
        catch(SQLException e) {
            System.out.println(e.getMessage());
        }
     ...
     public static void getTrainerSchedule() {
        String sql = "SELECT t.trainerFName, t.trainerLName, t.trainerSpeciality, s.sessionName, s.discipline, s.sessionCapacity, s.startTime, s.endTime, z.location AS zoneLocation, "
        ...
        try(Connection conn = Database.getConnection();
            PreparedStatement statement = conn.prepareStatement(sql)) {
                ...
                if(!found) System.out.println("No upcoming trainer schedules found.");
        }
        catch(SQLException e) {
            System.out.println(e.getMessage());
        }
